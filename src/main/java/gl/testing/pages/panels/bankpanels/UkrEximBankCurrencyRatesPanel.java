...
public class UkrEximBankCurrencyRatesPanel extends CurrencyRatesPanelTable1 {
    private SelenideElement tblExchangeRates = $x("//*[@class=\"content_2\"]/table[2]");

    private static final String COLUMNS_HEADERS_X_PATH = "tbody/tr[1]/*";
