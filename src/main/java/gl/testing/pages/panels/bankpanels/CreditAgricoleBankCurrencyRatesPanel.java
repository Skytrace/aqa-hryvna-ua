...
public class CreditAgricoleBankCurrencyRatesPanel extends CurrencyRatesPanelTable1 {
    private SelenideElement tblExchangeRates = $x("//*[@class=\"exchange-rates-table\"]/table[1]");

    private static final String COLUMNS_HEADERS_X_PATH = "thead/tr[1]/*";
